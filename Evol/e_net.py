...
l1_3 = conv_relu('c1_3','r1_3', data=l1_2, kernel=(3,3), num_filter=64, pad=(1,1))
...
l2_2 = conv_relu('c2_2','r2_2', data=l2_1, kernel=(3,3), num_filter=64, pad=(1,1))
l2_3 = conv_relu('c2_3','r2_3', data=l2_2, kernel=(3,3), num_filter=64, pad=(1,1), bn=True)

c2 = S.Concat(l2_3,p1,x1, num_args=3)
p2 = maxpool(c2)

l3_1 = conv_relu('c3_1','r3_1', data=p2,   kernel=(3,3), num_filter=64, pad=(1,1))
